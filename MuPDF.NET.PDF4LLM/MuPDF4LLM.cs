...
namespace MuPDF.NET.PDF4LLM
{
    ...
    public static partial class MuPDF4LLM
    {
        static MuPDF4LLM()
        {
            ...
            if (!string.Equals(actual, required, StringComparison.Ordinal))
            {
                throw new InvalidOperationException(
                    $"MuPDF.NET.PDF4LLM {VersionInfo.Version} requires MuPDF {VersionInfo.RequiredMuPdf}, " +
        ...
        /// <param name="doc">Document to convert (required for in-memory or non-path sources).</param>
        ...
        /// <summary>Convert a supported document path to Markdown.</summary>
        ...
        /// <summary>Convert a supported document path to layout JSON.</summary>
        /// <param name="path">Path to the document.</param>
        /// <param name="imageDpi">Resolution in dots per inch for extracted images.</param>
        /// <param name="imageFormat">Image file extension/format (for example <c>png</c>).</param>
        /// <param name="imagePath">Folder for written images when <paramref name="writeImages"/> is <see langword="true"/>.</param>
        ...
        /// <summary>Convert a supported document path to plain text.</summary>
        /// <param name="path">Path to the document.</param>
        /// <param name="filename">Logical file name stored in the parsed model metadata.</param>
        /// <param name="header">When <see langword="true"/>, include page-header regions in the output.</param>
        /// <param name="footer">When <see langword="true"/>, include page-footer regions in the output.</param>
