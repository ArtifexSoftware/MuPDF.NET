...
namespace MuPDF.NET.PDF4LLM.Llama
{
    /// <summary>Read supported documents and emit LlamaIndex documents.</summary>
    public class PDFMarkdownReader
    {
        ...
        /// <summary>
        /// Loads documents from a supported file and also accepts extra information in dict format.
        /// </summary>
        /// <param name="filePath">Path to the document (string or path-like object).</param>
