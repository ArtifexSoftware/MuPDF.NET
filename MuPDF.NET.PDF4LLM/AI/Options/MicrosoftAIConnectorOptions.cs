...
using MuPDF.NET.PDF4LLM.AI.Services;

namespace MuPDF.NET.PDF4LLM.AI.Options;

/// <summary>Configuration for <see cref="MsAIConnector"/>.</summary>
public sealed class MicrosoftAIConnectorOptions
{
    /// <summary>Use MuPDF.NET.PDF4LLM layout pipeline when a layout provider is registered.</summary>
    ...
    public IPdfExtractor? MuPDF4LLM { get; set; }
