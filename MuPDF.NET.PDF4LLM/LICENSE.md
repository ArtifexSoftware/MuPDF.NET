...
This **Artifex Community License** ("License") governs the use, reproduction, and distribution of **MuPDF.NET.PDF4LLM** ("Software") for non-commercial use. By using, modifying, or distributing this Software, you accept the terms of this License.
