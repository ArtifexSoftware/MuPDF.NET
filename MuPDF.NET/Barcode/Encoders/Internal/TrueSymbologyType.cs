...
namespace BarcodeWriter.Core.Internal
{
    ...
    /// </summary>
    enum TrueSymbologyType
    {
        /// <summary>
        /// Codabar barcode (aka Ames Code/USD-4/NW-7/2 of 7 Code). Codabar 
        /// symbology allows only symbols from this string '0123456789-$:/.+' 
        /// to be encoded.
        ...
        /// <summary>
        /// Code 39 barcode (aka USD-3, 3 of 9). Code 39 symbology allows 
        ...
        /// <summary>
        /// Interleaved 2 of 5 barcode. Interleaved 2 of 5 symbology allows 
        /// only numeric values to be encoded. This symbology is used primarily in 
        /// the distribution and warehouse industry.
        /// </summary>
        I2of5,

        /// <summary>
        /// Code 93 barcode (aka USS-93). Code 93 symbology allows 
        /// all ASCII symbols to be encoded in extended mode or symbols from
        /// this string "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%" in 
        ...
        /// <summary>
        /// Code 128 barcode. It is a very effective, high-density symbology 
        /// which permits the encoding of alphanumeric (subject to alphabet 
        /// selection) data. Code 128 is a very dense code, used extensively worldwide.
        /// </summary>
        Code128,

        /// <summary>
        /// EAN-13 barcode. Used with consumer products internationally. EAN-13
        /// symbology allows only numeric values to be encoded.
        /// </summary>
        EAN13,

        /// <summary>
        /// JAN-13 barcode (aka JAN codes). This symbology is mostly the same 
        /// as EAN-13 symbology, but used in Japan. JAN stands for Japanese 
        /// Numbering Authority. First two digits of JAN-13 symbology are always "49".
        /// </summary>
        JAN13,

        /// <summary>
        /// ISBN Number encoded as EAN-13 barcode. 
        /// </summary>
        ISBN,

        /// <summary>
        /// Bookland barcode. This symbology is mostly the same 
        ...
        /// <summary>
        /// UPC-A barcode. Used with consumer products in U.S. UPC-A symbology 
        /// allows only numeric values to be encoded.
        /// </summary>
        UPCA,

        /// <summary>
        /// UPC-E barcode. This symbology is zero-suppression version 
        ...
        /// <summary>
        /// EAN-8 barcode. This symbology is a short version of EAN-13 that
        ...
        /// <summary>
        /// Postnet barcode. This symbology usually gets printed by U.S. Post 
        ...
        /// <summary>
        /// PDF417 symbology. This symbology is heavily used in the parcel 
        ...
        /// <summary>
        /// PDF417 Truncated symbology. This symbology is a truncted (right column is missing) or
        /// compact version of PDF417 symbology. 
        /// </summary>
        PDF417Truncated,

        /// <summary>
        /// Data Matrix symbology. The most popular application for Data 
        ...
        /// <summary>
        /// QR Code symbology. QR Code initially was used for tracking parts in vehicle 
        ...
        /// <summary>
        /// Aztec Code symbology. An Aztec code barcode is used by Deutsche Bahn, 
        ...
        /// <summary>
        /// PLANET (The Postal Alpha Numeric Encoding Technique) barcode is used by 
        ...
        /// <summary>
        /// EAN128 symbology (Also known as EAN-128, EAN-14, Shipping 
        ...
        /// <summary>
        /// USPS Sack Label symbology (Also known as USPS 25 Sack Label). This
        ...
        /// <summary>
        /// USPS Tray Label symbology (Also known as USPS 25 Tray Label). This
        ...
        /// <summary>
        /// Deutsche Post Identcode (Also known as Deutsche Post AG IdentCode, 
        ...
        /// <summary>
        /// Deutsche Post Leitcode (Also known as German Postal 2 of 5 LeitCode, 
        ...
        /// <summary>
        /// Numly barcode (Also known as ESN, Electronic Serial Number). This
        ...
        /// <summary>
        /// Optical Product Code (Also known as OPC, Vision Council of America 
        ...
        /// <summary>
        /// Swiss Post Parcel (Also known as SwissPost Parcel Barcode, 
        ...
        /// <summary>
        /// Royal Mail barcode (Also known as RMS4CC, RoyalMail4SCC, 
        ...
        /// <summary>
        /// Dutch KIX barcode (Also known as Royal TNT Post Kix, Dutch 
        ...
        /// <summary>
        /// Singapore 4-State Postal Code barcode (Also known as Singapore 
        ...
        /// <summary>
        /// The EAN-2 (Also known as EAN/2 and EAN 2) is a supplement to 
        ...
        /// <summary>
        /// The EAN-5 (Also known as EAN/5 and EAN 5) is a supplement to
        /// EAN-13 and UPC-A barcodes. It is used often used to give a 
        /// suggestion for the price of the book.
        /// </summary>
        EAN5,

        /// <summary>
        /// The EAN14 symbology is used for traded goods.
        /// </summary>
        EAN14,

        /// <summary>
        /// The Macro version of PDF417 Symbology.
        /// </summary>
        MacroPDF417,

        /// <summary>
        /// The Micro version of PDF417 Symbology.
        /// </summary>
        MicroPDF417,

        /// <summary>
        /// GS1 DataMatrix is a 2D (two-dimensional) barcode that holds
        ...
        /// <summary>
        /// The Telepen symbology. This symbology is used in many countries and
        ...
        /// <summary>
        /// The Intelligent Mail Barcode symbology. 
        ...
        /// <summary>
        /// The GS1 DataBar Omnidirectional symbology. 
        /// </summary>
        GS1_DataBar_Omnidirectional,

        /// <summary>
        /// The GS1 DataBar Truncated symbology. 
        /// </summary>
        GS1_DataBar_Truncated,

        /// <summary>
        /// The GS1 DataBar Stacked symbology. 
        /// </summary>
        GS1_DataBar_Stacked,

        /// <summary>
        /// The GS1 DataBar Stacked Omnidirectional symbology. 
        /// </summary>
        GS1_DataBar_Stacked_Omnidirectional,

        /// <summary>
        /// The GS1 DataBar Limited symbology. 
        /// </summary>
        GS1_DataBar_Limited,

        /// <summary>
        /// The GS1 DataBar Expanded symbology. 
        /// </summary>
        GS1_DataBar_Expanded,

        /// <summary>
        /// The GS1 DataBar Expanded Stacked symbology. 
        /// </summary>
        ...
        /// <summary>
        /// The ITF-14 (GTIN-14, UCC-14) symbology
        ...
        /// <summary>
        /// GTIN-12 is UPC-A with 12 digits.
        /// </summary>
        GTIN12,
