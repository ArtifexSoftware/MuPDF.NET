...
{
    /// <summary>
    /// PDF boolean/null <see cref="PdfObj"/> singletons exposed on MuPDF's <c>mupdf</c> module.
    ...
    {
        /// <summary>
        /// Wrap a PDF object enum value as <see cref="PdfObj"/> .
        /// </summary>
