...
namespace MuPDF.NET
{
    ...
    public static class WxColors
    {
        ...
        /// <summary>Upper-case colour names derived from <see cref="ColorList"/>.</summary>
        ...
        internal static List<(string Name, int R, int G, int B)> colors_wx_list() => ColorList;
        internal static Dictionary<string, (float r, float g, float b)> colors_pdf_dict() => PdfColorDict;
    }
}