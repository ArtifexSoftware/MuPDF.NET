...
namespace MuPDF.NET
{
    ...
    public static class Utils
    {
        ...
        public static float[] GetColor(string name)
        {
            try
            {
                (string, float, float, float) c = Utils.GetColorInfoList()[Utils.GetColorList().IndexOf(name.ToUpper())];
        ...
        {
            PdfObj ocp = pdf.pdf_trailer().pdf_dict_get(new PdfObj("Root")).pdf_dict_get(new PdfObj("OCProperties"));
