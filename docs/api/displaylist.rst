...
.. class:: DisplayList
   ...
   .. method:: GetTextPage(int flags)
      ...
      :arg int flags: control which information is parsed into a text page. Default value in MuPDF.NET is `3 = TEXT_PRESERVE_LIGATURES | TEXT_PRESERVE_WHITESPACE`, i.e. :data:`ligatures` are **passed through**, white spaces are **passed through** (not translated to spaces), and images are **not included**. See :ref:`TextPreserve`.
