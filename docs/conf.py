...
extensions = ['sphinx_copybutton', 'notfound.extension', 'sphinxcontrib.googleanalytics', 'sphinx_tabs.tabs']
...
latex_documents = [("index", "MuPDFNET.tex", "MuPDF.NET Documentation", "Artifex", "manual")]
...
pdf_documents = [("index", "MuPDF.NET", "MuPDF.NET Manual", "Artifex")]
