...
{
    /// <summary>Port of <c>PyMuPDF-1.27.2.2/tests/test_textextract.py</c>.</summary>
    /// <remarks>
    ...
    public class TestTextextract
    {
        ...
        public void test_3186()
        {
            ...
            // codespell:ignore-begin — expected strings from PyMuPDF test (NUL bytes as \0 in PDF text).
        ...
        {
            // Port of test.py test_extendable_textpage() (2025-01-28 extendable stext across pages).
            Console.WriteLine();
